...
rule Windows_Trojan_RedLineStealer_f07b3cb4 {
  ...
  strings:
    $a1 = "<encrypted_key>k__BackingField"
    $a2 = "EB7EF1973CDC295B7B08FE6D82B9ECDAD1106AF2"
...
rule Windows_Trojan_RedLineStealer_4df4bcb6 {
  ...
  strings:
    $a1 = "4B05CEBD7D70F1607D474CAE176FEAEB7439795F"
...
rule Windows_Trojan_RedLineStealer_6dfafd7b {
  ...
  strings:
    $a = "38F431A549411AEB32810068A4C83250B2D31E15"
