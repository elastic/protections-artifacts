...
rule Linux_Generic_Threat_23d54a0e {
  ...
  strings:
    $a1 = ")+/01<=CLMPSZ["
    $a2 = "adxaesavxbincgodirdnsendfinfmaftpgc gp in intmapnilobjpc=ptrsetshasshtcpudp"
...
rule Linux_Generic_Threat_08e4ee8c {
  ...
  strings:
    $a1 = "xcryptography-2.1.4-py2.7.egg-info/PKG-INFO"
...
rule Linux_Generic_Threat_6bed4416 {
  ...
  strings:
    $a1 = "adxaesavxbincgodirdnsendfinfmaftpgc gp in intmapnilobjpc=ptrsetshasshtcpudp"
...
rule Linux_Generic_Threat_936b24d5 {
  ...
  strings:
    $a1 = "fseeko(opt.dict, 0L, SEEK_END) != -1"
...
rule Linux_Generic_Threat_9aaf894f {
  ...
  strings:
    $a1 = "/bin/cp /tmp/panwtest /usr/bin/ps"
...
rule Linux_Generic_Threat_ba3a047d {
  ...
  strings:
    $a1 = "Reading at malicious_x = %p... "
    $a2 = "(second best: 0x%02X score=%d)"
...
rule Linux_Generic_Threat_902cfdc5 {
  ...
  strings:
    $a1 = "TegskTGfBzL5ZXVeATJZ/Kg4gGwZNHviZINPIVp6K/-aw3x4amOW3feyTomlq7/WXkOJPhAhVPtgkpGtlhH"
...
rule Linux_Generic_Threat_47b147ec {
  ...
  strings:
    $a1 = "PATH=/bin:/sbin:/usr/sbin:/usr/bin:/usr/local/bin:/usr/local/sbin"
...
rule Linux_Generic_Threat_11041685 {
  ...
  strings:
    $a1 = "resolved symbol %s to %p"
    $a2 = "symbol table not available, aborting!"
...
rule Linux_Generic_Threat_0d22f19c {
  ...
  strings:
    $a1 = "UID %d, EUID:%d GID:%d, EGID:%d"
    $a2 = "PTRACE_POKEUSER fault"
...
rule Linux_Generic_Threat_0a02156c {
  ...
  strings:
    $a1 = "requires_null_page"
    $a2 = "get_exploit_state_ptr"
...
rule Linux_Generic_Threat_cd9ce063 {
  ...
  strings:
    $a1 = ",*struct { F uintptr; .autotmp_26 *tls.Conn }"
...
rule Linux_Generic_Threat_1ac392ca {
  ...
  strings:
    $a1 = "SOAPAction: urn:schemas-upnp-org:service:WANIPConnection:1#AddPortMapping"
...
rule Linux_Generic_Threat_1f5d056b {
  ...
  strings:
    $a1 = "abcdefghijklmnopqrstuvw012345678"
    $a2 = "GET /config HTTP/1.0"
...
rule Linux_Generic_Threat_ace836f1 {
  ...
  strings:
    $a1 = "NTLMSSP%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%s%s"
