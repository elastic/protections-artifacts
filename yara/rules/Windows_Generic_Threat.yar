...
rule Windows_Generic_Threat_232b71a9 {
  ...
  strings:
    $a1 = "aabcdeefghiijklmnoopqrstuuvwxyzaU"
...
rule Windows_Generic_Threat_efdb9e81 {
  ...
  strings:
    $a1 = "MaximumCheckBoxSize"
    $a2 = "VisualPlus.Native"
...
rule Windows_Generic_Threat_e96f9e97 {
  ...
  strings:
    $a1 = "zGM^ZM]K}mJAWKTI_LgmTR[QFCoq@FESg|]o"
...
rule Windows_Generic_Threat_54b0ec47 {
  ...
  strings:
    $a1 = "----=_%s_%.3u_%.4u_%.8X.%.8X"
    $a2 = "%s, %u %s %u %.2u:%.2u:%.2u %c%.2u%.2u"
...
rule Windows_Generic_Threat_5e718a0c {
  ...
  strings:
    $a1 = "D:(A;;0x001F0003;;;BA)(A;;0x00100003;;;AU)"
...
rule Windows_Generic_Threat_55d6a1ab {
  ...
  strings:
    $a1 = "QQ137239248 "
    $a2 = "tencent://message/?uin=137239248&Site=cf"
...
rule Windows_Generic_Threat_0350ed31 {
  ...
  strings:
    $a1 = "5jj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yzj)Yz?"
...
rule Windows_Generic_Threat_8b790aba {
  ...
  strings:
    $a1 = "zfbPJdsrxw{{yU6FBPJ? .n>6esz"
    $a2 = "P6{wdqydFJsdybEzwcbd"
...
rule Windows_Generic_Threat_820fe9c9 {
  ...
  strings:
    $a1 = ".*struct { F uintptr; X0 chan string; X1 bool }"
...
rule Windows_Generic_Threat_11a56097 {
  ...
  strings:
    $a1 = "noitpecxEtamroFegamIdaB"
    $a2 = "etubirttAetelosbO"
...
rule Windows_Generic_Threat_83c38e63 {
  ...
  strings:
    $a1 = "2eed656dd58e9505b4395420196fb356"
    $a2 = "4*4J4R4`4o4|4"
...
rule Windows_Generic_Threat_dee3b4bf {
  ...
  strings:
    $a1 = "Just copy the patch to the program directory and apply."
...
rule Windows_Generic_Threat_7526f106 {
  ...
  strings:
    $a1 = "Project1.uExWatch"
    $a2 = "lIEObject_DocumentComplete"
...
rule Windows_Generic_Threat_779cf969 {
  ...
  strings:
    $a1 = ">Copyright (c) Python Software Foundation. All rights reserved."
...
rule Windows_Generic_Threat_ccb6a7a2 {
  ...
  strings:
    $a1 = "@Range:bytes=0-"
    $a2 = "FIwA6KXIuNfKqIpK0MWMtI8KgMhI9K0MSIjKfMsIvKuMdIpK0MsIfKhMoIiCoMlIqK"
...
rule Windows_Generic_Threat_51a52b44 {
  ...
  strings:
    $a1 = "@jgrrlnhmgewwhticotmlwntjjqhrhbtudrxzcrgexepqszsuxkhnyctrcczmccicaahpf"
...
rule Windows_Generic_Threat_bbf2a354 {
  ...
  strings:
    $a1 = "That program must be run under Win32"
...
rule Windows_Generic_Threat_d6625ad7 {
  ...
  strings:
    $a1 = ".?AV<lambda_1>@?L@??on_event_add@Component_Keyloger@@EAEXI@Z@"
...
rule Windows_Generic_Threat_cafbd6a3 {
  ...
  strings:
    $a1 = "lksjfhglkjfsdg131"
    $a2 = "reg Delete \"HKLM\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\RunOnce\" /f > nul"
...
rule Windows_Generic_Threat_f0516e98 {
  ...
  strings:
    $a1 = "if exist %s goto :repeat"
    $a2 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmopqrstuvwxyz0123456789_"
...
rule Windows_Generic_Threat_deb82e8c {
  ...
  strings:
    $a1 = "Poverty is the parent of crime."
    $a2 = "- SystemLayout %d"
...
rule Windows_Generic_Threat_278c589e {
  ...
  strings:
    $a1 = "Installer will now download files required for installation."
...
rule Windows_Generic_Threat_4578ee8c {
  ...
  strings:
    $a1 = "User-Agent:Mozilla/4.0 (compatible; MSIE %d.0; Windows NT %d.1; SV1)"
...
rule Windows_Generic_Threat_dcc622a4 {
  ...
  strings:
    $a1 = "[!] Error writing shellcode to the target driver, abort"
...
rule Windows_Generic_Threat_5e33bb4b {
  ...
  strings:
    $a1 = "C:\\Users\\admin\\Desktop\\Work\\FileInstaller\\Release\\FileInstaller.pdb"
...
rule Windows_Generic_Threat_be64ba10 {
  ...
  strings:
    $a1 = "\"encrypted_key\":\"(.+?)\""
    $a2 = ".?AV<lambda_7ef8cf269a228b604d65432e7ec37014>@@"
...
rule Windows_Generic_Threat_7bb75582 {
  ...
  strings:
    $a1 = "HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings\\Connections [1 7 17]"
...
rule Windows_Generic_Threat_b7870213 {
  ...
  strings:
    $a1 = "u(knN00010203040506070809101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960616263646566676869707172737475767778798081828384858687888990919293949596979899"
...
rule Windows_Generic_Threat_2bba6bae {
  ...
  strings:
    $a1 = "65 79 41 69 64 48 6C 77 49 6A 6F 67 49 6B 70 58 56 43 49 73 49 43 4A 68 62 47 63 69 4F 69 41 69 52 57 52 45 55 30 45 69 49 48 30"
...
rule Windows_Generic_Threat_c8424507 {
  ...
  strings:
    $a1 = "xusehobimozacogojihogivo"
    $a2 = "bemitivegiwomezuvebag"
...
rule Windows_Generic_Threat_21253888 {
  ...
  strings:
    $a1 = "$403adc7a-9d4d-4d79-8c48-661adcff73e5"
